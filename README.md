...
<iframe src="https://giphy.com/embed/siyGcVZYHzpOJHYKo7" width="480" height="278" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p><a href="https://giphy.com/gifs/siyGcVZYHzpOJHYKo7">via GIPHY</a></p>
...
Vertex Buffers store vertex data, while Uniform Buffers store data that remains consistent across a single render pass.

##### Staging Buffers
Staging Buffers are used as temporary buffers to transfer data to GPU-accessible buffers efficiently.

##### Depth Buffers
Depth Buffers store depth information to handle overlapping objects correctly.

##### Command Buffers
Command Buffers store commands that will be submitted to the GPU.

##### Frame Buffers
Framebuffers are collections of memory attachments (e.g., color, depth, stencil attachments) where the output of rendering commands is stored.
